      ...
      <DialogContent className="sm:max-w-[900px] p-0 overflow-hidden bg-background">
        <div className="bg-gradient-to-br from-primary/10 via-background to-background p-6 max-h-[90vh] overflow-y-auto">
          ...
          <div className="text-center mt-4">
            <Button className="w-full sm:w-auto text-lg px-10 py-6 rounded-full shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5" onClick={() => window.open('https://t.me/OpenProfit_uz', '_blank')}>
