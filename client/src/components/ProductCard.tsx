		...
		>
			...
			>
				...
				<button
					...
					className='absolute top-2 right-2 w-8 h-8 rounded-full bg-background/80 flex items-center justify-center z-10 active:scale-90 transition-transform focus:outline-none focus-visible:ring-0'
